...
def apply_patches() -> None:
    ...
    DAG.explain = lambda self, node, costs=None: explain(self, node, costs)  # type: ignore[attr-defined]
    DAG.what_if = lambda self, **kw: what_if(self, **kw)  # type: ignore[attr-defined]
    DAG.lint = lambda self, **kw: lint(self, **kw)  # type: ignore[attr-defined]
    DAG.query = lambda self, expr: query(self, expr)  # type: ignore[attr-defined]
